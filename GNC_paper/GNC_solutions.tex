...
\pandocbounded{\includegraphics[keepaspectratio]{images/GNC_img_1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/GNC_img_2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/GNC_img_3.png}}
...
where \(l = \overset{\frown}{AA'}\) and \(r\) is radius and \(\theta\)
is angle suspended by the sector.
...
\node (check) [decision, below=1.4cm of opt] {Converged? \\ ($SSE < \mathrm{Tol} \; \text{or} \; MAX\; Itra$)};
...
condition, \(x_1(t_f) = 0.0\), but it was observed that, for few
...
\pandocbounded{\includegraphics[keepaspectratio]{images/GNC_img_4.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/GNC_img_5.png}}
...
This problem can also be solved using \(bvp_4c\) solver in MATLAB,
usuallly used to solved coupled ODEs with boundary conditions. The newer
methods like \emph{PINNs} can also be implemented to solve the same.
