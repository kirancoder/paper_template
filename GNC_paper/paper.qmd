...
Let's consider the states of the system, position and velocity at $t_0$, which are $[-0.15, 0.0]$. The positon is initially taken as negative, because at final time the body is experiences only spring force $F(t_f) = kx =0$, as $k$ can't be zero, we conclude that $x(t_f)=0$.
